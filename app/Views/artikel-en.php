...
<head>
    ...
    <!-- Hreflang Tags -->
    <link rel="alternate" hreflang="en" href="<?= base_url('/en/article'); ?>" />
    <link rel="alternate" hreflang="id" href="<?= base_url('/id/artikel'); ?>" />
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style="color: #009EF2;" href="<?= base_url('article'); ?>">Article</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="artikel">Indonesian</a></li>
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <?php foreach ($artikels as $ar): ?>
                <div class="col-md-4">
                    <div class="card">
                        <img src="<?= base_url('IMG/' . $ar['foto_artikel']); ?>" class="card-img-top"
                            alt="<?= $ar['judul_artikel']; ?>" loading="lazy">
                        <div class="card-body">
                            <h3 class="card-title"><?= $ar['judul_artikel']; ?></h3>
                            <p class="card-text"><?= $ar['deskripsi_artikel']; ?></p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text" style="font-size: 12px;">
                                    <?= date('Y-m-d', strtotime($ar['created_at'])); ?>
                                </span>
                                <a href="<?= base_url('article/' . $ar['id_artikel']); ?>" class="btn btn-primary">Baca
                                    Selengkapnya</a>
                            </div>
                        </div>
                    </div>
