...
<body>
    ...
    <div class="container">
        <!-- Judul Aktivitas -->
        <div class="activity-title"><?= $aktivitas['nama_aktivitas_in']; ?></div>
        ...
        <div class="activity-content">
            <p><?= $aktivitas['deskripsi_aktivitas_in']; ?></p>
        </div>
                ...
                <div class="col-md-4">
                    <a href="<?= base_url('/id/aktivitas/' . $aktivitas['id_aktivitas']); ?>"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h3 class="card-title"><?= $aktivitas['nama_aktivitas_in']; ?></h3>
                                <p class="card-text">
                                    <?= $aktivitas['deskripsi_aktivitas_in']; ?>
                                </p>
                            </div>
                        </div>
                    </a>
